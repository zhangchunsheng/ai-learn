...
class DataIterator:
    ...
    def input_pipeline(self, batch_size, num_epochs=None, aug=False):
        ...
        labels_tensor = tf.convert_to_tensor(self.labels, dtype=tf.string);
...
def build_graph(top_k):
    ...
    labels = tf.placeholder(dtype=tf.string, shape=[None], name='label_batch');
...
def main(_):
    ...
    if FLAGS.mode == "train":
        ...
        image_path = './data/test/丁/000.png'
